  ...
  return (
    <AnimatedBackground>
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        {/* CHECK-IN QR MOVED TO CpNav. It lived here as a card in the log-book
            list, which put a tool the CP reaches for AT A GATE inside a screen
            he reads at a desk. The nav carries it now, on every CP screen, and
            the modal resolves its own project rather than borrowing this
            screen's — see CheckinQrModal. Deliberately not left in both
            places: two entry points to one sheet is how they drift. */}
        <CpNav />
      </SafeAreaView>
    </AnimatedBackground>
  );
