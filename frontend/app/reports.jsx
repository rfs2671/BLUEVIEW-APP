                  ...
                  {historyLoading ? (
                    ...
                    <View style={s.historyList}>
                      <View style={s.historyHeader}>
                        <IconPod size={44}>
                          <Send size={18} strokeWidth={1.5} color={colors.text.secondary} />
                        </IconPod>
                        <View>
                          <Text style={s.historyTitle}>Sent Reports</Text>
                          <Text style={s.historySubtitle}>{historyTotal} total report{historyTotal !== 1 ? 's' : ''} sent</Text>
                        </View>
                      </View>
                      ...
                      {history.map((item, index) => (
                        <Pressable
                          ...
                          style={s.historyItem}
                          onPress={() => handleViewHistoryReport(item.date)}
                        >
                          <View style={s.historyItemLeft}>
                            <View style={s.historyDateBadge}>
                              <Text style={s.historyDateDay}>
                                {new Date(item.date + 'T12:00:00').getDate()}
                              </Text>
                              <Text style={s.historyDateMonth}>
                            ...
                            <View style={s.historyItemInfo}>
                              ...
                              <View style={s.historyMeta}>
                                <Clock size={11} strokeWidth={1.5} color={colors.text.subtle} />
                                <Text style={s.historyMetaText}>
                                  Sent {formatDateTime(item.sent_at)}
                                </Text>
                              </View>
                              {item.recipients && item.recipients.length > 0 && (
                                <View style={s.historyMeta}>
                                  <Mail size={11} strokeWidth={1.5} color={colors.text.subtle} />
                                  <Text style={s.historyMetaText}>
                    ...
                    <GlassCard style={s.emptyCard}>
                      <Send size={28} strokeWidth={1.5} color={colors.text.subtle} />
                      <Text style={s.emptyTitle}>No Reports Sent Yet</Text>
                      <Text style={s.emptySubtitle}>
                        Automatic reports will appear here once the scheduler sends them at the configured time.
                      </Text>
                    </GlassCard>
                  )}
                </>
