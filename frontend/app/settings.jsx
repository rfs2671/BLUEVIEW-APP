...
EOF
echo "settings done"",
      "description": "Write settings.jsx"
    },
    "message": "Write settings.jsx",
    ...
    "display_content": {
      "type": "json_block",
      "json_block": "{"language": "bash", "code": "cat > /mnt/user-data/outputs/settings.jsx << 'EOF'\
/**\
 * settings.jsx\
 * Place at: frontend/app/settings.jsx\
 *\
 * Accessible from FloatingNav (admin/owner) and CpNav (cp role).\
 * \
 * All roles:\
 *   - Change display name\
 *   - Light / Dark mode toggle\
 *\
 * Admin only (extra section):\
 *   - Change password\
 *\
 * Backend calls:\
 *   - PUT /api/auth/profile  \u2192 { name }         (all roles, name update)\
 *   - PUT /api/auth/password \u2192 { current_password, new_password }  (admin only)\
 *   Both are added to api.js as authAPI.updateProfile / authAPI.changePassword\
 */\
\
import React, { useState, useEffect } from 'react';\
import {\
