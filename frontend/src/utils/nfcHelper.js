 ...
 * @param {string} baseUrl - Base URL (e.g., "https://app.blueview.com")
 */
export async function writeNfcTag(projectId, tagId, baseUrl = 'https://app.blueview.com') {
  try {
 ...
 */
export async function registerNfcTag(projectId, baseUrl = 'https://app.blueview.com') {
  try {
